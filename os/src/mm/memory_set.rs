...
impl MemorySet {
    ...
    /// Map a memory area in kernel space
    pub fn find_memory_area(&mut self, _start: usize, _len: usize, _port: usize) -> isize {
        if _len == 0 {
    ...
    /// Unmap a memory area in kernel space
    pub fn delete_memory_area(&mut self, _start: usize, _len: usize) -> isize {
        if _len == 0 {
